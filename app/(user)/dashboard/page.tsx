  ...
  return (
    <main className={`${styles.main} px-1/6 md:px-[5vw] lg:px-[5vw]`}>
        <section className='flex flex-col gap-8 px-8 py-4'>
            <h1 className='text-3xl md:text-4xl lg:text-4xl'>Welcome back, Soham!</h1>
            ...
            <div className='flex flex-wrap gap-3'>
                {interestList.map((item,index)=>(
                    <div key={index} className='flex gap-2 items-center justify-center text-center bg-[#fff] p-2 border-2 border-[var(--clr-grey-300)] rounded-xl'>
                        ...
                        <p className='font-medium text-sm md:text-sm lg:text-sm'>{item.name}</p>
                    </div>
                ))}
        ...
        <aside className='bg-[#fff] h-fit-content rounded-xl px-8 py-8 flex flex-col items-center gap-5 border-2 border-[var(--clr-grey-300)]'>
            ...
            <div className='w-full rounded-lg flex flex-col gap-5'>
                <h2 className='text-center text-xl md:text-2xl lg:text-2xl'>@{username}</h2>
