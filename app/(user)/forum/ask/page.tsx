...
export default function ForumPage() {
  ...
  return (
    <main className='flex flex-col px-1/6 md:px-[10vw] lg:px-[10vw] gap-5'>
        ...
        <h1 className='tracking-tight text-lg md:text-xl lg:text-2xl'>Create A Post</h1>
        <Card>
            <form className='flex flex-col p-2 gap-5 w-full'>
                <div className='w-full'>
                    <h2 className='text-[var(--clr-grey-500)] tracking-tight text-sm md:text-base lg:text-lg'>Question summary</h2>
                ...
                <div className='w-full'>
                    <h2 className='text-[var(--clr-grey-500)] tracking-tight text-sm md:text-base lg:text-lg'>Question description</h2>
                    <textarea className='focus:outline-none w-full border-2 border-[var(--clr-grey-300)] rounded-xl p-2 text-xs md:text-sm lg:text-sm' placeholder='Add a description to provide more details' value={content}  />
            ...
            <Button type='' style='btn--primary' size='btn--sm' >Send</Button>
