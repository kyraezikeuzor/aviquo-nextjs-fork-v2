    ...
    page: (
      <div className="flex flex-col">
        <div className="flex justify-between items-center">
          <h3 className="text-base md:text-lg lg:text-xl tracking-normal">
            Account Settings
          </h3>
        ...
        <Card>
          <ul className="flex flex-col gap-10 p-4">
            <li className="flex justify-between">
              <h2 className="text-lg md:text-xl lg:text-2xl tracking-normal">
                Account Settings
              </h2>
            ...
            <li className="flex justify-between">
              ...
              <div
                onClick={() =>
                  handleClick({ title: "Accessibility", view: Views[1].page })
                }
              >
                <Icon icon="arrow-right" fillColor="black" />
              </div>
            ...
            <li className="flex justify-between">
              ...
              <div
                onClick={() =>
                  handleClick({ title: "Notifications", view: Views[2].page })
                }
              >
                <Icon icon="arrow-right" fillColor="black" />
              </div>
