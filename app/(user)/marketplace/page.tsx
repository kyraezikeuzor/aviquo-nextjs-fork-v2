    ...
    <main className='flex flex-col gap-5 px-1/6 md:px-[10vw] lg:px-[10vw]'>
        ...
        <section className={`${styles['forum__content__container']}`}>
            ...
            <h2 className='text-lg md:text-xl lg:text-xl tracking-normal'>Create Post</h2>
                ...
                <h2 className='text-lg md:text-xl lg:text-xl tracking-normal'>Topics</h2>
                <Card>
                    
                    <div className='flex flex-wrap gap-2'>
                        {interestList.map((item,index)=>(
                            <Tag key={index} type="tag">{item.name}</Tag>
                        ))}
                    </div>
                </Card>
                <h2 className='text-lg md:text-xl lg:text-xl tracking-normal'>Contributions</h2>
                <Card>
