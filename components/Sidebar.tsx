...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      cssRootSidebarWideScreenWidth,
      !sidebar ? "50px" : "calc(100vw * 1/7)",
    );
  }, [sidebar]);
  ...
  return (
    <div>
      <div
        className={`${styles.sidebar} h-[100vh] border-r-2 border-[var(--clr-grey-300)] fixed flex flex-col items-center px-1`}
      >
        <div
          className={`${sidebar ? `w-[var(--w-sidebar)] px-4` : `w-[50px]`}`}
        >
          <div
